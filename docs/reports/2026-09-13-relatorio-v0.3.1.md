...
O catálogo reúne **20,034 registros de candidatura**. A camada financeira agrega **R$ 5.112.304.856,00** em receitas e **R$ 2.204.954.519,64** em despesas contratadas.

## Candidaturas por cargo

| Cargo | Registros | Participação |
|---|---:|---:|
| Deputado Estadual/Distrital | 11,709 | 58.45% |
| Deputado Federal | 7,793 | 38.90% |
| Senador | 319 | 1.59% |
| Governador | 200 | 1.00% |
| Presidente | 13 | 0.06% |
...
- financas: 0.185 h de idade; SLA 18 h; OK.
- camara: 9.215 h de idade; SLA 36 h; OK.

## Proveniência

Fonte: `MSsanto/Elei-oes-2026` · branch `main` · commit `1440f76b42ce7cd05f4fc9d17a3f155c7eed434a`.
